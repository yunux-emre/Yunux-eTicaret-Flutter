...
import 'package:mobil_projesi/widgets/auth/image_picker_widget.dart';
  ...
  Future<void> _registerFCT() async {
    ...
    if (_pickedImage == null) {
      MyAppFunctions.showErrorOrWarningDialog(
        context: context,
        subtitle: "Bir resim aldığınızdan emin olun",
        fct: () {},
      );
      return;
    }
                ...
                children: [
                  ...
                  const Align(
                    ...
                    child: Column(
                      ...
                      children: [
                        TitlesTextWidget(label: "Hesap oluşturun"),
                        SubtitleTextWidget(
                          label: "Devam etmek için bilgilerinizi doldurun.",
                        ),
                      ],
                    ),
                  ),
