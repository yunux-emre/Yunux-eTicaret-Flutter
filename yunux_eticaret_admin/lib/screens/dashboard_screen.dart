import 'package:yunux_eticaret_admin/models/dashboard_btn_model.dart';
import 'package:yunux_eticaret_admin/widgets/dashboard_btns.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const TitlesTextWidget(label: "Kontrol Paneli"),
        leading: Padding(
