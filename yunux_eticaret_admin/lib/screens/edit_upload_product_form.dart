...
import 'package:yunux_eticaret_admin/consts/app_constants.dart';
import 'package:yunux_eticaret_admin/consts/validator.dart';
import 'package:yunux_eticaret_admin/models/product_model.dart';
import 'package:yunux_eticaret_admin/screens/loading_manager.dart';
import 'package:yunux_eticaret_admin/services/my_app_functions.dart';
  ...
  Future<void> _uploadProduct() async {
    ...
    if (_categoryValue == null) {
      MyAppFunctions.showErrorOrWarningDialog(
        context: context,
        subtitle: "Lütfen bir kategori seçin",
        fct: () {},
      );
      return;
    }
    if (_pickedImage == null) {
      MyAppFunctions.showErrorOrWarningDialog(
        context: context,
        subtitle: "Lütfen bir görsel seçin",
        fct: () {},
      );
      return;
    }
        ...
        child: Scaffold(
              ...
              child: Row(
                ...
                children: [
                  ElevatedButton.icon(
                    ...
                    label:
                        const Text("Temizle", style: TextStyle(fontSize: 20)),
                    onPressed: () {
                      clearForm();
                    },
                  ),
                  ElevatedButton.icon(
                    ...
                    label: Text(isEditing ? "Ürünü düzenle" : "Ürün yükle"),
                    onPressed: () {
                      if (isEditing) {
                        _editProduct();
                      } else {
          ...
          appBar: AppBar(
            ...
            title: TitlesTextWidget(
              label: isEditing ? "Ürünü düzenle" : "Yeni ürün yükle",
            ),
          ),
          body: SafeArea(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                child: const Text("Ürün görseli seç"),
                              ),
                            ],
                          ),
                        ),
                        ...
                        children: [
                              ...
                              Flexible(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    return MyValidators.uploadProdTexts(
                                      value: value,
                                      toBeReturnedString: "Adet girilmedi",
                                    );
                                  },
                                ),
                              ),
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              return MyValidators.uploadProdTexts(
                                value: value,
                                toBeReturnedString: "Açıklama girilmedi",
                              );
                            },
                            onTap: () {},
                          ),
